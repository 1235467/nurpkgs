...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "8dfdcfb35385eabb821e668d327b30ea3e483ab8";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "8dfdcfb35385eabb821e668d327b30ea3e483ab8";
      fetchSubmodules = true;
      sha256 = "sha256-zm/69dW2rkPAhVEeIJkqag01vtPeRzKTc/ojGlPrZ1U=";
    };
    date = "2025-12-11";
  };
  hyprwayland-scanner = {
  ...
  nbfc-linux = {
    pname = "nbfc-linux";
    version = "3b67a71dc9d72c096e0d8593895fbde5fee4362b";
    src = fetchFromGitHub {
      owner = "nbfc-linux";
      repo = "nbfc-linux";
      rev = "3b67a71dc9d72c096e0d8593895fbde5fee4362b";
      fetchSubmodules = false;
      sha256 = "sha256-qL2IncmPO1RRy/EgJ3IwYykTBfR/3vSEg8yoF2Q/s/s=";
    };
    date = "2025-12-11";
  };
  ncmdump_rs = {
  ...
  qcm = {
    pname = "qcm";
    version = "a1fbebc5bb0db20a2787cb710ae51879369059c2";
    src = fetchFromGitHub {
      owner = "hypengw";
      repo = "Qcm";
      rev = "a1fbebc5bb0db20a2787cb710ae51879369059c2";
      fetchSubmodules = true;
      sha256 = "sha256-VqLICKU8rZ3R8KHlNm1whxVBiaF96voIW0dbH07Szuw=";
    };
    date = "2025-12-11";
  };
  reflac = {
  ...
  swgp-go = {
    pname = "swgp-go";
    version = "48e88d50e619e88d5c809cd79bab01f30db3ba6d";
    src = fetchFromGitHub {
      owner = "database64128";
      repo = "swgp-go";
      rev = "48e88d50e619e88d5c809cd79bab01f30db3ba6d";
      fetchSubmodules = false;
      sha256 = "sha256-VfUtbWhGPeud4ZlJcG96nHvGFkp6b2o9eeE+0fnpaw0=";
    };
    date = "2025-12-08";
  };
  wayland = {
  ...
  waylyrics = {
    pname = "waylyrics";
    version = "a9bc4d9eafd75a8c15f796cc18fc7842c1b7300e";
    src = fetchFromGitHub {
      owner = "waylyrics";
      repo = "waylyrics";
      rev = "a9bc4d9eafd75a8c15f796cc18fc7842c1b7300e";
      fetchSubmodules = false;
      sha256 = "sha256-KdVFb5xUpIVkUVf4RUsdHBbmxdEf0Lw5mA9l3ECq8KY=";
    };
    date = "2025-12-03";
  };
  wlroots = {
    pname = "wlroots";
    version = "0e9c6ddefa11b56564abcf0c8317ef9f70d4f3d3";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "0e9c6ddefa11b56564abcf0c8317ef9f70d4f3d3";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-OUqFZlRDhBfaWZLUydsGCePRKZEVjvzUM4ro+59RidA=";
    };
    date = "2025-12-11";
  };
}
