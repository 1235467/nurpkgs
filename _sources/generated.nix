...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  av1an = {
    pname = "av1an";
    version = "940883fbd1c3af6c67ff67efffe727faf1b9b669";
    src = fetchFromGitHub {
      owner = "master-of-zen";
      repo = "av1an";
      rev = "940883fbd1c3af6c67ff67efffe727faf1b9b669";
      fetchSubmodules = false;
      sha256 = "sha256-luwKUqXa+E05LOoe3BmlCEQwmSqWyd38ivb3Acd3RGc=";
    };
    date = "2025-09-04";
  };
  bypy = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "b8cff8a4342fbb17367e21b95fafad8d6ec2960d";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "b8cff8a4342fbb17367e21b95fafad8d6ec2960d";
      fetchSubmodules = true;
      sha256 = "sha256-ONWybtfnDju8pRcPHSpfaQyp+SbYUD+62lVAR4xUgtE=";
    };
    date = "2025-09-10";
  };
  hyprwayland-scanner = {
  ...
  mieru = {
    pname = "mieru";
    version = "cec2b108f52456c0bbe954a0af74eca9633dfec3";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "cec2b108f52456c0bbe954a0af74eca9633dfec3";
      fetchSubmodules = false;
      sha256 = "sha256-RCn1QHAnM47iYnHlm9Bazl/j2ni6Dqx8qj1g+X7AkOA=";
    };
    date = "2025-09-08";
  };
  nbfc-linux = {
  ...
  qcm = {
    pname = "qcm";
    version = "3ca119ae687dba0489a6e64c7ffada9d8148d5d1";
    src = fetchFromGitHub {
      owner = "hypengw";
      repo = "Qcm";
      rev = "3ca119ae687dba0489a6e64c7ffada9d8148d5d1";
      fetchSubmodules = true;
      sha256 = "sha256-Y3a36zTgkzwIgK9euwo03DI7ZtTLXqaXvZlYQ3Lw+z0=";
    };
    date = "2025-09-07";
  };
  reflac = {
  ...
  sway = {
    pname = "sway";
    version = "c5456be7506adece2cdf922ed6d919db597944ab";
    src = fetchFromGitHub {
      owner = "swaywm";
      repo = "sway";
      rev = "c5456be7506adece2cdf922ed6d919db597944ab";
      fetchSubmodules = true;
      sha256 = "sha256-1b4SFuvA3fXc3EIdVMahZeRhv/bWmwVByFz4egMuGTg=";
    };
    date = "2025-09-09";
  };
  swgp-go = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "905465b0fa5e64cb966afda7d2e5d3c04a0438d2";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "905465b0fa5e64cb966afda7d2e5d3c04a0438d2";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ApYLRp6dwlcUg6j5VRYNkUJwIaGjCKxNOMkR/LRY7Sk=";
    };
    date = "2025-09-09";
  };
}
