...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "709855842068315bb2109d8f422a70c2b5ed1931";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "709855842068315bb2109d8f422a70c2b5ed1931";
      fetchSubmodules = true;
      sha256 = "sha256-SRkXohRVFg1dJlnZyzjGezar1XByFMW99g8b2HjDHf0=";
    };
    date = "2025-12-16";
  };
  hyprwayland-scanner = {
  ...
  nbfc-linux = {
    pname = "nbfc-linux";
    version = "f3416fbb8cc84453ae13ecfbc7cdc27706222411";
    src = fetchFromGitHub {
      owner = "nbfc-linux";
      repo = "nbfc-linux";
      rev = "f3416fbb8cc84453ae13ecfbc7cdc27706222411";
      fetchSubmodules = false;
      sha256 = "sha256-U17mMSEtVdEGntW8bTaRRXhamct7Iguei26R8c1QAow=";
    };
    date = "2025-12-16";
  };
  ncmdump_rs = {
  ...
  qcm = {
    pname = "qcm";
    version = "dbee66eec377ced11efebef9288eb5a9c5dab771";
    src = fetchFromGitHub {
      owner = "hypengw";
      repo = "Qcm";
      rev = "dbee66eec377ced11efebef9288eb5a9c5dab771";
      fetchSubmodules = true;
      sha256 = "sha256-C+xSf9PaNwnkVuhYkVmSzZx6+5Lgdjgkjz/QXL8vebk=";
    };
    date = "2025-12-15";
  };
  reflac = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "9b4d9eabb1071a63a1daa547d1264c99b49291e8";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "9b4d9eabb1071a63a1daa547d1264c99b49291e8";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-5AH/7LaQj7Qe5gDFDoevqrc5i3znK7vsK7qgLxlwpRU=";
    };
    date = "2025-12-15";
  };
}
