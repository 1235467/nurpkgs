...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "30756d871845a6058a840642ab1a4c3979f6d782";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "30756d871845a6058a840642ab1a4c3979f6d782";
      fetchSubmodules = true;
      sha256 = "sha256-rQ4no/+LHuHlqDbJopj6fgS9GUsv1NSycrVhIoLPnbs=";
    };
    date = "2026-02-03";
  };
  hyprwayland-scanner = {
  ...
  mieru = {
    pname = "mieru";
    version = "3eeb5b6007bebb7ee1d2d389f3bd07d4cd0afe95";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "3eeb5b6007bebb7ee1d2d389f3bd07d4cd0afe95";
      fetchSubmodules = false;
      sha256 = "sha256-PYeBMmRJpk1CTOZaSXVnnY1CDwiHzlF1EOcH8+i5CQM=";
    };
    date = "2026-02-02";
  };
  nbfc-linux = {
    pname = "nbfc-linux";
    version = "cf39c7bb8ea0566ed722615a559e9c7a2b03132a";
    src = fetchFromGitHub {
      owner = "nbfc-linux";
      repo = "nbfc-linux";
      rev = "cf39c7bb8ea0566ed722615a559e9c7a2b03132a";
      fetchSubmodules = false;
      sha256 = "sha256-1QBVGjktGx+UDAmNYBbXZWJy+EbsJ4s/66TRNHpB/wE=";
    };
    date = "2026-02-01";
  };
  ncmdump_rs = {
  ...
  sway = {
    pname = "sway";
    version = "b081eba05d463cace54eebc1e2f73b23f470949a";
    src = fetchFromGitHub {
      owner = "swaywm";
      repo = "sway";
      rev = "b081eba05d463cace54eebc1e2f73b23f470949a";
      fetchSubmodules = true;
      sha256 = "sha256-tDFh6IVzIxbJOs2Lt3kWgTM8VOwEMhnorcGt6Y9pWkE=";
    };
    date = "2026-02-02";
  };
  swgp-go = {
  ...
  wayland = {
    pname = "wayland";
    version = "dbf45d11a324fffdc1122a303c691898f942c508";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wayland/wayland";
      rev = "dbf45d11a324fffdc1122a303c691898f942c508";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-3uoGMgxHcDz/KdEZatjsU+awJHA9ni3GcMES2xE/ErM=";
    };
    date = "2026-02-02";
  };
  wayland-protocols = {
  ...
  waylyrics = {
    pname = "waylyrics";
    version = "7e5a9dd05a00dbcc30d86aa13f57114124f34ee1";
    src = fetchFromGitHub {
      owner = "waylyrics";
      repo = "waylyrics";
      rev = "7e5a9dd05a00dbcc30d86aa13f57114124f34ee1";
      fetchSubmodules = false;
      sha256 = "sha256-jkXIw6bYKTU1/s4WB8XJn8Qba9p9KIJ6mYvMQynNtYo=";
    };
    date = "2026-02-01";
  };
  wlroots = {
    pname = "wlroots";
    version = "4fe51aa43982cafc3881b1380d7b491d245d40f5";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "4fe51aa43982cafc3881b1380d7b491d245d40f5";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-dulwDZuIt8j8hbZLy8RipzzF2th3bjPQW2vJLOdo9HM=";
    };
    date = "2026-02-02";
  };
}
