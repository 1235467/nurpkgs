...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  av1an = {
    pname = "av1an";
    version = "4ce01e0359fb303479ad11af9d3a976ce65960cd";
    src = fetchFromGitHub {
      owner = "master-of-zen";
      repo = "av1an";
      rev = "4ce01e0359fb303479ad11af9d3a976ce65960cd";
      fetchSubmodules = false;
      sha256 = "sha256-8YSsjy4xE8LgDxhHErDvnivUtnWwkoZbnZTyhzXaI3Q=";
    };
    date = "2025-12-07";
  };
  bypy = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "f8d5aad1a1f61e1b6443c27394a38c8c54d39e9e";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "f8d5aad1a1f61e1b6443c27394a38c8c54d39e9e";
      fetchSubmodules = true;
      sha256 = "sha256-K9nX/n7EG+/6YUeRttdsNZHmaaO/0jHQ4qBD5Rsj0hE=";
    };
    date = "2025-12-06";
  };
  hyprwayland-scanner = {
  ...
  libdrm = {
    pname = "libdrm";
    version = "b71953a1995ffc1683e1f636a9cfedaeed0646e1";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/mesa/drm";
      rev = "b71953a1995ffc1683e1f636a9cfedaeed0646e1";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-CfEEulciy3jEQd0P1A8yBjG9LXeJq1OBxXp7akFOr6o=";
    };
    date = "2025-12-04";
  };
  llamafile = {
  ...
  mieru = {
    pname = "mieru";
    version = "99761fbf74abe917eaa961fca7c8642246cf51d9";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "99761fbf74abe917eaa961fca7c8642246cf51d9";
      fetchSubmodules = false;
      sha256 = "sha256-OavVV8dFHK75JDUboQ3laymQjjmzWRV5bpz5lAjcjxc=";
    };
    date = "2025-12-07";
  };
  nbfc-linux = {
  ...
  qcm = {
    pname = "qcm";
    version = "0150a4eae9c4e4a79205aa0fe70f98d0ce2b299f";
    src = fetchFromGitHub {
      owner = "hypengw";
      repo = "Qcm";
      rev = "0150a4eae9c4e4a79205aa0fe70f98d0ce2b299f";
      fetchSubmodules = true;
      sha256 = "sha256-BDdTs1dlz7ik3ken4Yjhly+Bxfbg6bWwoIaIhIP7Y5Q=";
    };
    date = "2025-12-05";
  };
  reflac = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "a962d58727bf5a95ef0da50dce21031728c92f2c";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "a962d58727bf5a95ef0da50dce21031728c92f2c";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-kiWjr1NzA1GvOCNhiq3Br2PxnpSN94ImQHh6YHa8Ojs=";
    };
    date = "2025-12-05";
  };
}
