...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  av1an = {
    pname = "av1an";
    version = "77c2cbae519aebbf1355d9e29cb5ff883565d978";
    src = fetchFromGitHub {
      owner = "master-of-zen";
      repo = "av1an";
      rev = "77c2cbae519aebbf1355d9e29cb5ff883565d978";
      fetchSubmodules = false;
      sha256 = "sha256-HX+Q04oikE5eGdZGHqBOLeTWUtlxVcH1KuGBsHf5ZeM=";
    };
    date = "2026-01-16";
  };
  bypy = {
  ...
  hyprland = {
    pname = "hyprland";
    version = "92a3b9199939c8b7b61281d1d59dbaa9cc2b2d6c";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
      rev = "92a3b9199939c8b7b61281d1d59dbaa9cc2b2d6c";
      fetchSubmodules = true;
      sha256 = "sha256-hNrM4WtccSDpxledw4+t/NHRZOy64peM9Qw2l1PalZo=";
    };
    date = "2026-01-17";
  };
  hyprwayland-scanner = {
  ...
  mieru = {
    pname = "mieru";
    version = "6c9c1a755c1c50bd90a5c39407d423e118e01f70";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "6c9c1a755c1c50bd90a5c39407d423e118e01f70";
      fetchSubmodules = false;
      sha256 = "sha256-twiKiYxy6meK5mIzDmpZTQUQa7f3Vm2hgMhA7G6almQ=";
    };
    date = "2026-01-15";
  };
  nbfc-linux = {
  ...
  swgp-go = {
    pname = "swgp-go";
    version = "fd30f820106a45200b62d761c99f59d312d4f21c";
    src = fetchFromGitHub {
      owner = "database64128";
      repo = "swgp-go";
      rev = "fd30f820106a45200b62d761c99f59d312d4f21c";
      fetchSubmodules = false;
      sha256 = "sha256-I/50X4zVu044kVCVfDVAjTg+vWzPKJtoL/9RCZueX/Q=";
    };
    date = "2026-01-12";
  };
  wayland = {
    pname = "wayland";
    version = "5a45a89a83c78a2a1f817d71c6cf94830a89d31e";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wayland/wayland";
      rev = "5a45a89a83c78a2a1f817d71c6cf94830a89d31e";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-cDN5++2pNlq8DHbk+CD0dS87gFZtvt8eFfWIjHB2kzI=";
    };
    date = "2026-01-13";
  };
  wayland-protocols = {
  ...
  wlroots = {
    pname = "wlroots";
    version = "f735439543a483348def37272e1bcf59696e639b";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wlroots/wlroots";
      rev = "f735439543a483348def37272e1bcf59696e639b";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-8AIfmfgiPjdpwEVcr6/t7hx4EpL6hEhuf4QfB731DE4=";
    };
    date = "2026-01-15";
  };
}
