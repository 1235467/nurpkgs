...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  hyprland = {
    pname = "hyprland";
    version = "02ff413002eddd7419ba70eb0f9f92acd2d97ddc";
    src = fetchFromGitHub {
      owner = "hyprwm";
      repo = "Hyprland";
  ...
  mieru = {
    pname = "mieru";
    version = "ca48b49e710f5235f03f2f880f8b00fe5a98237c";
    src = fetchFromGitHub {
      owner = "enfein";
      repo = "mieru";
      rev = "ca48b49e710f5235f03f2f880f8b00fe5a98237c";
      fetchSubmodules = false;
      sha256 = "sha256-Wbpt//cKWpGEn8IsL8Tq+bTYE8Xwm8s4l5pJwhh9Rvc=";
    };
    date = "2026-02-04";
  };
  nbfc-linux = {
    pname = "nbfc-linux";
    version = "4ba6f6cfae1559b9ae074ab67f1410f2d821a72d";
    src = fetchFromGitHub {
      owner = "nbfc-linux";
      repo = "nbfc-linux";
      rev = "4ba6f6cfae1559b9ae074ab67f1410f2d821a72d";
      fetchSubmodules = false;
      sha256 = "sha256-UzNkuqLZK8H5WNAJNRKpD3TuBAg7UZVAtPs3npxa7+I=";
    };
    date = "2026-02-04";
  };
  ncmdump_rs = {
  ...
  wayland-protocols = {
    ...
    version = "fedde2456ed1572ad4d46fff119220cb845e79d6";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/wayland/wayland-protocols";
      rev = "fedde2456ed1572ad4d46fff119220cb845e79d6";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-DXGNurA3Tqvxmmy8ILtp68y07m7dXaxGESo/dBcqgUo=";
    };
    date = "2026-02-05";
  };
  waylyrics = {
    pname = "waylyrics";
    version = "4d272b1ebf55ea10b422ebdb5be4cca7f181913f";
    src = fetchFromGitHub {
      owner = "waylyrics";
      repo = "waylyrics";
      rev = "4d272b1ebf55ea10b422ebdb5be4cca7f181913f";
      fetchSubmodules = false;
      sha256 = "sha256-tLIRFgvhU98nmlJm+pb+ZQWRNBBPR0/RQN/raQkYfRY=";
    };
    date = "2026-02-03";
  };
  wlroots = {
    pname = "wlroots";
    version = "90f9f59041b9d02809d4d64f45ca6ff2e61a722e";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-SL8AwuMBLQ86D+mUWLxs5nDlrUALuUvyGsoyWEcn8NY=";
    };
    date = "2026-02-04";
  };
}
