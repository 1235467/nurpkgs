...
stdenv.mkDerivation rec {
  ...
  cmakeFlags = [
    ...
    "-DYUZU_USE_EXTERNAL_SIMPLEINI=ON"
  ...
  preConfigure = ''
    ...
    cp -r ${simpleini} externals/simpleini
    cp -r ${vma} externals/VulkanMemoryAllocator
    cp -r ${pkgs.vulkan-utility-libraries.src} externals/Vulkan-Utility-Libraries
    rm -rf externals/dynarmic
    rm -rf externals/sirit
    rm -rf externals/xbyak
    cp -r ${dynarmic} externals/dynarmic
